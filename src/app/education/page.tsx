...
const Education: React.FC<EducationPageProps> = ({className}) => {
  // Assuming a default aspect ratio or size for local images.
  // PLEASE ADJUST width and height to match the actual dimensions of your images.
  const defaultWidth = 400;
  const defaultHeight = 300; // Example height, adjust as needed
          ...
          <div className="mt-6 space-y-6 w-full">
            ...
            <div className="grid gap-4">
              ...
              <div className="flex justify-center">
                <Image
                  src="/images/loughborough-london-external.jpg"
                  alt="Loughborough University London"
                  width={defaultWidth} // Adjust
                  height={defaultHeight} // Adjust
            ...
            <div className="grid gap-4">
              ...
              <div className="flex justify-center">
                <Image
                  src="/images/StStithiansFinalyearphoto.jpg"
                  alt="St Stithians Final Year Photo"
                  width={defaultWidth} // Adjust
                  height={defaultHeight} // Adjust
                  className={imageStyle}
                />
             ...
             <div className="grid gap-4">
              ...
              <div className="flex justify-center">
                <Image
                  src="/images/StJohnsImage.jpeg"
                  alt="St John's Prep Harare"
                  width={defaultWidth} // Adjust
                  height={defaultHeight} // Adjust
                  className={imageStyle}
                />
